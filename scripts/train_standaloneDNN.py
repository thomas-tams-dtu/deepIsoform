...
if NETWORK_SIZE == 'small':
    fnn = FeedForwardIsoform_small(input_shape = gene_expr[0].size(), 
                             output_shape = isoform_expr[0].size())
elif NETWORK_SIZE == 'medium':
    fnn = FeedForwardIsoform_medium(input_shape = gene_expr[0].size(), 
                             output_shape = isoform_expr[0].size())
elif NETWORK_SIZE == 'large':
    fnn = FeedForwardIsoform_large(input_shape = gene_expr[0].size(), 
                             output_shape = isoform_expr[0].size())
elif NETWORK_SIZE == 'XL':
    fnn = FeedForwardIsoform_XL(input_shape = gene_expr[0].size(), 
                             output_shape = isoform_expr[0].size())
elif NETWORK_SIZE == 'XXL':
    fnn = FeedForwardIsoform_XXL(input_shape = gene_expr[0].size(), 
                             output_shape = isoform_expr[0].size())
