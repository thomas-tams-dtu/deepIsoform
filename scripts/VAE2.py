...
class VAE_lf(nn.Module):
    def __init__(self, input_shape:torch.Size, latent_features:int) -> None:
        ...
        self.decoder = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.01),
            nn.BatchNorm1d(self.latent_features*2),
        ...
        self.enc_mu = nn.Linear(int(self.latent_features), self.latent_features)
        self.enc_logvar = nn.Linear(int(self.latent_features), self.latent_features)
